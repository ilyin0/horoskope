...
_i1.GetIt $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i7.AboutYouCubit>(
      () => _i7.AboutYouCubit(get<_i6.NatalChartsRepository>()));
  gh.factory<_i8.CompatibilityCubit>(
      () => _i8.CompatibilityCubit(get<_i3.CompatibilityRepository>()));
  gh.factory<_i9.HoroskopeCubit>(
      () => _i9.HoroskopeCubit(get<_i5.HoroskopeRepository>()));
  return get;
}

class _$ContentDataModule extends _i10.ContentDataModule {}
